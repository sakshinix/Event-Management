...
<center><img src="logo.jpeg" width="150px" height="150px" style="border-radius:50%;" ></center>
	 ...
	 <input type="text" name="uname" id="uname" value="" placeholder="User Name"  required autocomplete="off"></br></br>
	 
	 <input type="text" name="email" id="email" value="" placeholder="Email"  required autocomplete="off"></br></br>
	 
     <input type="password" name="pass" id="pass" value="" placeholder="New password" required  autocomplete="off"></br></br>
	 <input type="checkbox" id="togglePassword" onclick="myfun()" > Show Password</br></br>
	 <button  type="submit">Submit</button>  <button type="reset">Reset</button>
	<button><a href="signin.php">Back</a></button></br></br>
	</form></center>
</body>
</html>